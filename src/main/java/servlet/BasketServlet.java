...
public class BasketServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getSession().setAttribute("productsInBasket", (new BasketDao().returnListOfProductsInBasket(person)));
        if (person.getBaskets().size() == 0) {
...
//                }
            ...
            if (req.getParameter("address").isEmpty() || req.getParameter("phoneNumber").isEmpty()) {
                ...
                personDao.setPhoneNumberAndAddress(person, req.getParameter("phoneNumber"), req.getParameter("address"));
                //person.buyBasket();
